...
half3 lightColor = mainLight.color.rgb;
					...
					#else
					#ifdef USE_RT
								specularReflection = specularReflection - lerp(0, saturate(0.075), saturate(saturate(1 - ripples3 * 4) * calculatedNormal.x * reflect(lightDirection, normalDirection)).x * _NormalRTStrength);
								specularReflection = specularReflection + lerp(0, saturate(0.125), saturate(saturate(1 - ripples3 * 8) * calculatedNormal.x * reflect(-lightDirection, normalDirection)).x * _NormalRTStrength);
